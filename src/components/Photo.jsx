  ...
  return (
    <div className="max-w-[1400px] mx-auto py-[10px] md:py-[40px] px-4 text-white">
      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-4 py-11">
        ...
        <div>
          <img className="object-cover rounded-lg" src={build2} alt="" />
        ...
        <div>
          <img className="object-cover rounded-lg" src={house} alt="" />
      ...
      <div className="flex justify-center items-center">
        <Link to="/gallery">
          <button className="bg-[#00df9a] text-black cursor-pointer  rounded-md font-medium w-[200px] mb-4  px-6 py-3">
            View More
          </button>
        </Link>
      </div>
